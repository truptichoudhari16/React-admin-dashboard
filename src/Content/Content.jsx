...
import Analytics from "../Components/AnalyticsTepmlate/Analytics";
    ...
    <div className={`content ${DarkTheme && "dark"}`}>
      ...
      <div className="row tall-square inv-bg">
        ...
        <div className="admin">
          ...
          <div className="info">
            <h2 className="admin-name">Trupti Choudhari</h2>
        ...
        <section>
          ...
          <div className="summary">
            ...
            <span className="summary-info">
              ...
              similique quisquam corporis, a voluptatibus rerum maiores minus
              omnis sit.
            </span>
          </div>
        ...
        <section>
          ...
          <div className="more-details">
            ...
            <span className="txt">
              ...
              voluptas natus eveniet incidunt nam magni iusto mollitia
              repudiandae nostrum?
            </span>
          </div>
        </section>
